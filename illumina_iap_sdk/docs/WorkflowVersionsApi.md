# illumina_iap_sdk.WorkflowVersionsApi
...
with illumina_iap_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = illumina_iap_sdk.WorkflowVersionsApi(api_client)
    workflow_id = 'workflow_id_example' # str | ID of the workflow
body = illumina_iap_sdk.CreateWorkflowVersionRequest() # CreateWorkflowVersionRequest |  (optional)
...
body = illumina_iap_sdk.LaunchWorkflowVersionRequest() # LaunchWorkflowVersionRequest |  (optional)
...
with illumina_iap_sdk.ApiClient(configuration) as api_client:
    ...
    workflow_id = 'workflow_id_example' # str | ID of the workflow
version_name = 'version_name_example' # str | Name of the workflow version
body = illumina_iap_sdk.UpdateWorkflowVersionRequest() # UpdateWorkflowVersionRequest |  (optional)
