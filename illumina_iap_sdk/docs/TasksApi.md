...
with illumina_iap_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = illumina_iap_sdk.TasksApi(api_client)
    body = illumina_iap_sdk.CreateTaskRequest() # CreateTaskRequest |  (optional)
...
with illumina_iap_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = illumina_iap_sdk.TasksApi(api_client)
    task_id = 'task_id_example' # str | 
body = illumina_iap_sdk.UpdateTaskRequest() # UpdateTaskRequest | Details of the task to be updated. (optional)
