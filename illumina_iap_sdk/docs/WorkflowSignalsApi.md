# illumina_iap_sdk.WorkflowSignalsApi
...
with illumina_iap_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = illumina_iap_sdk.WorkflowSignalsApi(api_client)
    signal_id = 'signal_id_example' # str | ID of the workflow signal
body = illumina_iap_sdk.FailWorkflowSignalRequest() # FailWorkflowSignalRequest |  (optional)
...
with illumina_iap_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = illumina_iap_sdk.WorkflowSignalsApi(api_client)
    signal_id = 'signal_id_example' # str | ID of the workflow signal
body = illumina_iap_sdk.SucceedWorkflowSignalRequest() # SucceedWorkflowSignalRequest |  (optional)
