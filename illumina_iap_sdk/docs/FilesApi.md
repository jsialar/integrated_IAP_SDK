...
with illumina_iap_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = illumina_iap_sdk.FilesApi(api_client)
    file_id = 'file_id_example' # str | Unique identifier for the file to be archived.
body = illumina_iap_sdk.FileArchiveRequest() # FileArchiveRequest | 
...
with illumina_iap_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = illumina_iap_sdk.FilesApi(api_client)
    body = illumina_iap_sdk.CreateFileRequest() # CreateFileRequest | 
...
body = illumina_iap_sdk.FileUnarchiveRequest() # FileUnarchiveRequest | 
...
include = 'include_example' # str | Comma-separated list of properties to include in the response ([include=[totalItemCount]).Example: include=totalItemCount (optional)
body = illumina_iap_sdk.UpdateFileRequest() # UpdateFileRequest |  (optional)
