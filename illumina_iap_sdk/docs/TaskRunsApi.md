...
with illumina_iap_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = illumina_iap_sdk.TaskRunsApi(api_client)
...
with illumina_iap_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = illumina_iap_sdk.TaskRunsApi(api_client)
    body = illumina_iap_sdk.CreateTaskRunRequest() # CreateTaskRunRequest |  (optional)
...
with illumina_iap_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = illumina_iap_sdk.TaskRunsApi(api_client)
    run_id = 'run_id_example' # str | 
body = illumina_iap_sdk.HeartbeatTaskRunRequest() # HeartbeatTaskRunRequest |  (optional)
