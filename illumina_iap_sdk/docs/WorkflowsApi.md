...
with illumina_iap_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = illumina_iap_sdk.WorkflowsApi(api_client)
    body = illumina_iap_sdk.CreateWorkflowRequest() # CreateWorkflowRequest |  (optional)
...
with illumina_iap_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = illumina_iap_sdk.WorkflowsApi(api_client)
    workflow_id = 'workflow_id_example' # str | ID of the workflow
body = illumina_iap_sdk.UpdateWorkflowRequest() # UpdateWorkflowRequest |  (optional)
