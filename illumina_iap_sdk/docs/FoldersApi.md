...
with illumina_iap_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = illumina_iap_sdk.FoldersApi(api_client)
    folder_id = 'folder_id_example' # str | Unique identifier for the folder to be archived.
body = illumina_iap_sdk.FolderArchiveRequest() # FolderArchiveRequest | 
...
body = illumina_iap_sdk.CompleteSessionRequest() # CompleteSessionRequest | The request body
...
body = illumina_iap_sdk.FolderCopyRequest() # FolderCopyRequest | 
...
with illumina_iap_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = illumina_iap_sdk.FoldersApi(api_client)
    body = illumina_iap_sdk.CreateFolderRequest() # CreateFolderRequest | 
...
body = illumina_iap_sdk.FolderUnarchiveRequest() # FolderUnarchiveRequest | 
...
include = 'include_example' # str | Comma-separated list of properties to include in the response ([include=[totalItemCount]).Example: include=totalItemCount (optional)
body = illumina_iap_sdk.FolderUpdateRequest() # FolderUpdateRequest |  (optional)
