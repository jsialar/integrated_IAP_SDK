# illumina_iap_sdk.WorkflowRunsApi
...
with illumina_iap_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = illumina_iap_sdk.WorkflowRunsApi(api_client)
...
body = illumina_iap_sdk.AbortWorkflowRunRequest() # AbortWorkflowRunRequest |  (optional)
