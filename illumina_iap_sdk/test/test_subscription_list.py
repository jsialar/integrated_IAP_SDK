...
from illumina_iap_sdk.models.subscription_list import SubscriptionList  # noqa: E501
...
class TestSubscriptionList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = illumina_iap_sdk.models.subscription_list.SubscriptionList()  # noqa: E501
        if include_optional :
            return SubscriptionList(
                items = [
                    illumina_iap_sdk.models.subscription.Subscription(
                        id = '0', 
                        urn = '0', 
                        type = '0', 
                        actions = [
                        ...
                        name = '0', 
                        description = '0', 
                        delivery_target = illumina_iap_sdk.models.delivery_target.DeliveryTarget(
