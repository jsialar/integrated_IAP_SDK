...
from illumina_iap_sdk.models.workflow_signal_list import WorkflowSignalList  # noqa: E501
...
class TestWorkflowSignalList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = illumina_iap_sdk.models.workflow_signal_list.WorkflowSignalList()  # noqa: E501
        if include_optional :
            return WorkflowSignalList(
                items = [
                    illumina_iap_sdk.models.workflow_signal_compact.WorkflowSignalCompact(
                        id = '0', 
                        urn = '0', 
                        href = '0', 
                        ...
                        type = '0', 
                        description = '0', 
                        inputs = illumina_iap_sdk.models.inputs.inputs(), 
                        workflow_run = illumina_iap_sdk.models.workflow_run_compact.WorkflowRunCompact(
                            id = '0', 
                            urn = '0', 
                            href = '0', 
                            name = '0', 
                            ...
                            error = '0', 
                            error_cause = '0', 
                            workflow_version = illumina_iap_sdk.models.workflow_version_compact.WorkflowVersionCompact(
                                id = '0', 
                                urn = '0', 
                                href = '0', 
                                version = '0', 
                        ...
                        timeout_seconds = 56, 
                        result = illumina_iap_sdk.models.result.result(), 
                        error = '0', 
                        error_cause = '0', 
                        created_by_client_id = '0', 
                        time_created = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
