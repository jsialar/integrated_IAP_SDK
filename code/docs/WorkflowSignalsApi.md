# integrated_sdk.WorkflowSignalsApi
...
with integrated_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = integrated_sdk.WorkflowSignalsApi(api_client)
    signal_id = 'signal_id_example' # str | ID of the workflow signal
body = integrated_sdk.FailWorkflowSignalRequest() # FailWorkflowSignalRequest |  (optional)
...
with integrated_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = integrated_sdk.WorkflowSignalsApi(api_client)
    signal_id = 'signal_id_example' # str | ID of the workflow signal
body = integrated_sdk.SucceedWorkflowSignalRequest() # SucceedWorkflowSignalRequest |  (optional)
