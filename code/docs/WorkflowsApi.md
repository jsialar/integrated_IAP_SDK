...
with integrated_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = integrated_sdk.WorkflowsApi(api_client)
    body = integrated_sdk.CreateWorkflowRequest() # CreateWorkflowRequest |  (optional)
...
with integrated_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = integrated_sdk.WorkflowsApi(api_client)
    workflow_id = 'workflow_id_example' # str | ID of the workflow
body = integrated_sdk.UpdateWorkflowRequest() # UpdateWorkflowRequest |  (optional)
