# integrated_sdk.WorkflowVersionsApi
...
with integrated_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = integrated_sdk.WorkflowVersionsApi(api_client)
    workflow_id = 'workflow_id_example' # str | ID of the workflow
body = integrated_sdk.CreateWorkflowVersionRequest() # CreateWorkflowVersionRequest |  (optional)
...
body = integrated_sdk.LaunchWorkflowVersionRequest() # LaunchWorkflowVersionRequest |  (optional)
...
with integrated_sdk.ApiClient(configuration) as api_client:
    ...
    workflow_id = 'workflow_id_example' # str | ID of the workflow
version_name = 'version_name_example' # str | Name of the workflow version
body = integrated_sdk.UpdateWorkflowVersionRequest() # UpdateWorkflowVersionRequest |  (optional)
