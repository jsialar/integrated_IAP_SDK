...
------------ | ------------- | ------------- | -------------
**items** | [**[AnalysisDatasetCompact]**](AnalysisDatasetCompact.md) | Items in paged list | [optional] 
...
**sorted_by** | **str** | Sort order of item list | [optional]  if omitted the server will use the default value of "TimeCreated"
