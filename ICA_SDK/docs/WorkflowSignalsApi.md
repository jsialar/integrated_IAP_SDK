...
with ICA_SDK.ApiClient(configuration) as api_client:
    ...
    api_instance = ICA_SDK.WorkflowSignalsApi(api_client)
    signal_id = 'signal_id_example' # str | ID of the workflow signal
body = ICA_SDK.FailWorkflowSignalRequest() # FailWorkflowSignalRequest |  (optional)
...
with ICA_SDK.ApiClient(configuration) as api_client:
    ...
    api_instance = ICA_SDK.WorkflowSignalsApi(api_client)
    signal_id = 'signal_id_example' # str | ID of the workflow signal
body = ICA_SDK.SucceedWorkflowSignalRequest() # SucceedWorkflowSignalRequest |  (optional)
