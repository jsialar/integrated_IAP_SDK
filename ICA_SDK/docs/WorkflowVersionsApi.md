...
with ICA_SDK.ApiClient(configuration) as api_client:
    ...
    api_instance = ICA_SDK.WorkflowVersionsApi(api_client)
    workflow_id = 'workflow_id_example' # str | ID of the workflow
body = ICA_SDK.CreateWorkflowVersionRequest() # CreateWorkflowVersionRequest |  (optional)
...
body = ICA_SDK.LaunchWorkflowVersionRequest() # LaunchWorkflowVersionRequest |  (optional)
...
with ICA_SDK.ApiClient(configuration) as api_client:
    ...
    workflow_id = 'workflow_id_example' # str | ID of the workflow
version_name = 'version_name_example' # str | Name of the workflow version
body = ICA_SDK.UpdateWorkflowVersionRequest() # UpdateWorkflowVersionRequest |  (optional)
