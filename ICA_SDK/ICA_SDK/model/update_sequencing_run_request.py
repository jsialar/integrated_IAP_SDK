...
class UpdateSequencingRunRequest(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """UpdateSequencingRunRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            run_name (str): User-provided name of the experiment/run  Not guaranteed to be unique for either request token or system  If null or undefined, existing value is left as is  Any other non-null values are used to update the RunName field of the run  This property is considered metadata, and is restricted by metadata update rules. [optional]  # noqa: E501
            description (str): User-provided description of the experiment/run  If null or undefined, existing value is left as is  Any other non-null values are used to update the RunName field of the run  This property is NOT considered metadata, and is not restricted by metadata update rules  If the run is locked, description may only be updated by the user who locked the run. [optional]  # noqa: E501
            prep_kit_info (SequencingRunPrepKitInfo): [optional]  # noqa: E501
            flow_cell_barcode (str): The barcode of the FlowCell used in the sequencing run.  If null or undefined, existing value is left as is  Any other non-null values are used to update the RunName field of the run  This property is considered metadata, and is restricted by metadata update rules. [optional]  # noqa: E501
            ...
            sample_sheet_name (str): Name of the sample sheet file  If null or undefined, existing value is left as is  Any other non-null values are used to update the RunName field of the run  This property is considered metadata, and is restricted by metadata update rules. [optional]  # noqa: E501
            is_favorite (bool): Set the run as favorite runs. [optional]  # noqa: E501
