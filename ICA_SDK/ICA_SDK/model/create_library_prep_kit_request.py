...
class CreateLibraryPrepKitRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, allowed_read_types, *args, **kwargs):  # noqa: E501
        """CreateLibraryPrepKitRequest - a model defined in OpenAPI
