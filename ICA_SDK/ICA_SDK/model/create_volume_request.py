...
class CreateVolumeRequest(ModelNormal):
    ...
    def __init__(self, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            volume_configuration_name (str): Unique name of the volume configuration to use. [optional]  # noqa: E501
            root_key_prefix (str): The base bucket location for volumes associated with custom VolumeConfigurations. If not provided, the given volume Name is used.  If provided, it must start with the VolumeConfiguration's keyprefix and end with a /.  To create a volume representing the root of a bucket, use the value '/'.. [optional]  # noqa: E501
            metadata ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Metadata about this volume and its contents. [optional]  # noqa: E501
