...
class CreateIndexAdapterKitRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, allowed_index_strategies, *args, **kwargs):  # noqa: E501
        """CreateIndexAdapterKitRequest - a model defined in OpenAPI
