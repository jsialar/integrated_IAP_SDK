...
import ICA_SDK
from ICA_SDK.models.folder_list_response import FolderListResponse  # noqa: E501
...
class TestFolderListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = ICA_SDK.models.folder_list_response.FolderListResponse()  # noqa: E501
        if include_optional :
            return FolderListResponse(
                items = [
                    ICA_SDK.models.folder_response.FolderResponse(
                        id = '0', 
                        name = '0', 
                        volume_id = '0', 
                        volume_name = '0', 
