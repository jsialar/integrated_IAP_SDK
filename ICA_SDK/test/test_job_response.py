...
import ICA_SDK
from ICA_SDK.models.job_response import JobResponse  # noqa: E501
...
class TestJobResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = ICA_SDK.models.job_response.JobResponse()  # noqa: E501
        if include_optional :
            return JobResponse(
                id = '0', 
                parent_folder_urn = '0', 
                operation_type = 'Unknown', 
                operation_parameters = ICA_SDK.models.job_operation_parameters.JobOperationParameters(
